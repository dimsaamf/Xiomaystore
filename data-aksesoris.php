...
<body>
    ...
    <div class="session">
        <div class="container">
            <h3>Data Aksesoris</h3>
            <div class="box">
                <p><a href="tambah-aksesoris.php">Tambah Data</a></p>
                <table border="1" cellspacing="0" class="table">
                    ...
                    <tbody>
                        ...
                        include 'config.php';
                            ...
                            while($row=mysqli_fetch_object($aksesoris)){
                            ?>
                        <tr>
                            <td><?php echo $no++ ?></td>
                            <td><?php echo $row->nama ?></td>
                            <td><a href="assets/aksesoris/<?php echo $row->gambar ?>" target="_blank"><img
                                        src="assets/aksesoris/<?php echo $row->gambar ?>" alt="" width="60px"></a></td>
                            <td>Rp. <?php echo number_format( $row->harga) ?></td>
                            <td><?php echo $row->stok ?></td>
                            <td><a href="edit-aksesoris.php?id=<?php echo $row->id_aksesoris ?>">Edit</a> || <a
                                    href="delete.php?id_a=<?php echo $row->id_aksesoris ?>"
